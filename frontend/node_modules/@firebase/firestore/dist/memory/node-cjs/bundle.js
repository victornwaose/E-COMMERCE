...
function loadBundle(data) {
    return databaseF7ed7346.loadBundle(this._delegate, data);
}
function namedQuery(queryName) {
    return databaseF7ed7346.namedQuery(this._delegate, queryName).then(expQuery => {
        if (!expQuery) {
            return null;
        }
        return new databaseF7ed7346.Query$1(this, 
...
registerBundle(databaseF7ed7346.Firestore);
